/**
 * Benchmark: maskSeries (replace values < 0 with NaN) on 100k-element Series
 */
import { Series, maskSeries } from "../../src/index.js";
...
const s = new Series({ data: Array.from(data) });
